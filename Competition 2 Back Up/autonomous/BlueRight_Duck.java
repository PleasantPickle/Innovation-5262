...
public class BlueRight_Duck extends LinearOpMode
{
    ...
    public void runOpMode() // throws InterruptedException
    {
        ...
        if (opModeIsActive())
        {
            try
            {
                // Turn Slightly to make contact with the carousel
                //turn(robotDiameter, wheelDiameter, 40, true, ANDYMARK_NEVEREST_40_RPM);
                drive(7, wheelDiameter, true, ANDYMARK_NEVEREST_40_RPM);
                
                // Deliver Duck
                carouselSpinner.setPower(-0.21);
                Thread.sleep(3000);
