...
public class DriverControlled extends LinearOpMode 
{
    ...
    // right bumper spins the carouselSpinner FORWARD
    // left bumper spins the carouselSpinner REVERSE
    ...
    public void runOpMode() 
    {
        ...
        while (opModeIsActive()) 
        {
            ...
            // Carousel Spinner
            if (gamepad1.right_bumper) // if the right bumper is down
            {
                carouselSpinner.setPower(0.6); // spin motor
            }
            else if (gamepad1.left_bumper)// if the left bumper is down
            {
                carouselSpinner.setPower(-0.6); // stop motor
            }
            else
            {
            ...
            //carouselSpinner.setPower(gamepad1.right_trigger);
